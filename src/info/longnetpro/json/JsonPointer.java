...
public class JsonPointer implements Serializable {
    ...
    public static JsonType resolve(JsonType jsonObj, String reference, boolean isJsonFormat) throws JsonPointerException {
    ...
    public static String[] evaluteReference(String reference, boolean isJsonFormat) throws JsonPointerException {
        ...
        if (isJsonFormat) {
            try {
                ref = JsonParser.parse('"' + reference + '"', false).toString();
